...
<qgis maxScale="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.4.10-Madeira" simplifyAlgorithm="0" simplifyDrawingHints="1" simplifyLocal="1" labelsEnabled="1" minScale="1e+08" styleCategories="AllStyleCategories" readOnly="0">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" type="RuleRenderer" forceraster="0">
    <rules key="{50d3457e-d6af-448e-9356-be7e90fbc4fa}">
      <rule scalemaxdenom="150000" scalemindenom="50000" symbol="0" filter=" $area > 500" key="{011edacd-6a57-4a9c-a2cb-f1773a6032dc}" label="Buildings 1:150,000 - 1:50,000"/>
      <rule scalemaxdenom="50000" scalemindenom="15000" symbol="1" key="{14b3297f-d003-4db6-9ad8-4867d90ceaf7}" label="Buildings 1:50,000 - 1:15,000"/>
      <rule scalemaxdenom="50000" scalemindenom="15000" symbol="2" key="{cb225b9c-2951-4fd4-bf63-b8911dc22fe9}" label="Buildings 1:50,000 - 1:15,000"/>
      <rule scalemaxdenom="15000" scalemindenom="10000" symbol="3" key="{7fd7943f-ee73-4e60-8b53-35681fc84d0c}" label="Buildings 1:15,000 - 1:10,000"/>
      <rule scalemaxdenom="10000" scalemindenom="1" symbol="4" key="{c442b945-525a-4b39-b313-70bf4f207e18}" label="Buildings 1:10,000 - 1:1"/>
    </rules>
    <symbols>
      <symbol alpha="1" name="0" force_rhr="0" clip_to_extent="1" type="fill">
        <layer locked="0" pass="0" class="SimpleFill" enabled="1">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="210,156,63,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          <prop v="237,175,180,0" k="outline_color"/>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="fillColor" type="Map">
                  ...
                  <Option name="expression" value="lighter(@symbol_color,randf(100,120))" type="QString"/>
      ...
      <symbol alpha="1" name="1" force_rhr="0" clip_to_extent="1" type="fill">
        <layer locked="0" pass="0" class="SimpleFill" enabled="1">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="148,109,25,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          <prop v="148,109,25,255" k="outline_color"/>
          <prop v="solid" k="outline_style"/>
          <prop v="0.26" k="outline_width"/>
          <prop v="MM" k="outline_width_unit"/>
          <prop v="solid" k="style"/>
      ...
      <symbol alpha="1" name="3" force_rhr="0" clip_to_extent="1" type="fill">
        <layer locked="0" pass="0" class="SimpleFill" enabled="1">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="131,97,100,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0.20000000000000001,0.20000000000000001" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          <prop v="131,97,100,255" k="outline_color"/>
          <prop v="solid" k="outline_style"/>
          <prop v="0.26" k="outline_width"/>
          <prop v="MM" k="outline_width_unit"/>
          <prop v="solid" k="style"/>
        ...
        <layer locked="0" pass="0" class="SimpleFill" enabled="1">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="139,103,106,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          <prop v="139,103,106,255" k="outline_color"/>
          <prop v="solid" k="outline_style"/>
          <prop v="0.26" k="outline_width"/>
          <prop v="MM" k="outline_width_unit"/>
          <prop v="solid" k="style"/>
      ...
      <symbol alpha="1" name="4" force_rhr="0" clip_to_extent="1" type="fill">
        <layer locked="0" pass="0" class="SimpleFill" enabled="1">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="185,135,55,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          <prop v="237,175,143,215" k="outline_color"/>
          <prop v="solid" k="outline_style"/>
          <prop v="0.26" k="outline_width"/>
          <prop v="MM" k="outline_width_unit"/>
          <prop v="solid" k="style"/>
  ...
  <labeling type="rule-based">
    <rules key="{76465db9-9c91-4572-99c7-5d4c678e6a41}">
      <rule description="Building on the go" key="{6dd2b3fc-31ba-4353-b34b-ecaff945096d}">
        <settings>
          <text-style fontSizeUnit="Pixel" blendMode="0" previewBkgrdColor="#ffffff" fontStrikeout="0" isExpression="0" useSubstitutions="0" fontUnderline="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSize="15" fontWeight="50" fontCapitals="0" namedStyle="Regular" multilineHeight="1" textColor="172,120,0,255" fontLetterSpacing="0" fontWordSpacing="0" fieldName="name" fontItalic="0" fontFamily="Times New Roman" textOpacity="1">
            <text-buffer bufferDraw="0" bufferOpacity="1" bufferJoinStyle="128" bufferSize="1" bufferNoFill="1" bufferColor="255,255,255,255" bufferBlendMode="0" bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0"/>
          ...
          <placement yOffset="0" rotationAngle="0" centroidWhole="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" offsetType="0" placementFlags="10" repeatDistanceUnits="MM" priority="5" distUnits="MM" xOffset="0" centroidInside="1" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistance="0" offsetUnits="MM" dist="0" distMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" placement="7" quadOffset="4" maxCurvedCharAngleIn="25" preserveRotation="1"/>
          <rendering minFeatureSize="0" drawLabels="1" limitNumLabels="0" obstacleFactor="1" fontLimitPixelSize="0" scaleMin="0" scaleMax="0" fontMaxPixelSize="10000" obstacle="1" mergeLines="0" zIndex="0" displayAll="0" maxNumLabels="2000" scaleVisibility="0" obstacleType="0" fontMinPixelSize="3" labelPerPart="0" upsidedownLabels="0"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
              <Option name="properties"/>
