...
<qgis maxScale="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.4.10-Madeira" simplifyAlgorithm="0" simplifyDrawingHints="0" simplifyLocal="1" labelsEnabled="0" minScale="1e+08" styleCategories="AllStyleCategories" readOnly="0">
  <flags>
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" type="RuleRenderer" forceraster="0">
    <rules key="{09cccc54-6ea8-4457-bd12-89befe760901}">
      <rule symbol="0" filter=" &quot;fclass&quot;  =  'christian' " key="{e4ffe4d0-6ea3-4dbc-82ae-b3820310c117}"/>
    </rules>
    <symbols>
      <symbol alpha="1" name="0" force_rhr="0" clip_to_extent="1" type="marker">
        <layer locked="0" pass="0" class="SvgMarker" enabled="1">
          ...
          <prop v="holsten-gate.svg" k="name"/>
          <prop v="0,0" k="offset"/>
  ...
  <DiagramLayerSettings zIndex="0" obstacle="0" linePlacementFlags="18" placement="0" dist="0" priority="0" showAll="1">
    <properties>
      <Option type="Map">
        <Option name="name" value="" type="QString"/>
        <Option name="properties"/>
